<?php
	...
	class InstanceSpySpec extends ObjectBehavior {
		 ...
		 */
		public function it_can_be_built_from_a_php_unit_invocation_and_a_mock_object( \PHPUnit_Framework_MockObject_Matcher_Invocation $invocation, SomeClass $object ) {
		 ...
		 */
		public function it_will_forward_non_spy_calls_to_the_object( \PHPUnit_Framework_MockObject_Matcher_Invocation $invocation, SomeClass $object ) {
		 ...
		 */
		public function it_will_forward_was_called_times_to_the_invocation_object( \PHPUnit_Framework_MockObject_Matcher_AnyInvokedCount $invocation, SomeClass $object ) {
			$invocations = array();
