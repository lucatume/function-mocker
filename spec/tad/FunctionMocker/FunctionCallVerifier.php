<?php
	...
	class FunctionCallVerifierSpec extends ObjectBehavior {
		 ...
		 */
		public function it_allows_checking_if_the_return_value_is_a_callable( Checker $checker, ReturnValue $returnValue, SpyCallLogger $invocation ) {
		 ...
		 */
		public function it_allows_checking_if_a_function_has_been_eval_created_to_mock_it( Checker $checker, ReturnValue $returnValue, SpyCallLogger $invocation ) {
		 ...
		 */
		public function it_allows_getting_the_mocked_function_name( Checker $checker, ReturnValue $returnValue, SpyCallLogger $invocation ) {
		 ...
		 */
		public function it_allows_getting_the_number_of_calls_to_the_function( Checker $checker, ReturnValue $returnValue, SpyCallLogger $invocation ) {
		 ...
		 */
		public function it_allows_getting_the_number_of_calls_to_the_function_filtering_them_by_call_args( Checker $checker, ReturnValue $returnValue, SpyCallLogger $invocation ) {
			$sut = $this::__from( $checker, $returnValue, $invocation );
		 ...
		 */
		public function it_will_throw_if_call_times_is_wrong( Checker $checker, ReturnValue $returnValue, SpyCallLogger $invocation ) {
			$sut = $this::__from( $checker, $returnValue, $invocation );
		 ...
		 */
		public function it_will_throw_if_call_times_is_wrong_per_args( Checker $checker, ReturnValue $returnValue, SpyCallLogger $invocation ) {
			$sut = $this::__from( $checker, $returnValue, $invocation );
			$invocation->getCallTimes( [ 'some' ] )->willReturn( 2 );
		 ...
		 */
		public function it_allows_checking_for_0_calls_using_sugar_method( Checker $checker, ReturnValue $returnValue, SpyCallLogger $invocation ) {
			$sut = $this::__from( $checker, $returnValue, $invocation );
