...
class FunctionMockerInstanceTest extends \PHPUnit_Framework_TestCase
{
    ...
    public function it_should_allow_verifying_an_instance_method_was_called_times_with_args_when_spying($times, $calls, $shouldThrow)
    {
        ...
        $spy->wasCalledWithTimes(array(23,
            23), $times);
    }
    ...
    {
        return [
            [[new \stdClass(), [1, 2, 3], 'foo'], [FunctionMocker::isInstanceOf('stdClass'),
                FunctionMocker::isType('array'),
                FunctionMocker::isType('string')], false],
            [[null, [1, 2, 3], 'foo'], [FunctionMocker::isInstanceOf('stdClass'),
                FunctionMocker::isType('array'),
                FunctionMocker::isType('string')], true],
            [[new \stdClass(), null, 'foo'], [FunctionMocker::isInstanceOf('stdClass'),
                FunctionMocker::isType('array'),
                FunctionMocker::isType('string')], true],
            [[new \stdClass(), [1, 2, 3], null], [FunctionMocker::isInstanceOf('stdClass'),
                FunctionMocker::isType('array'),
                FunctionMocker::isType('string')], true],
            [['foo', [], null], [FunctionMocker::isInstanceOf('stdClass'),
                FunctionMocker::isType('array'),
                FunctionMocker::isType('string')], true],
            [['foo', [], null], [FunctionMocker::anything(),
                FunctionMocker::anything(),
                FunctionMocker::anything()], false]
        ];
    }
