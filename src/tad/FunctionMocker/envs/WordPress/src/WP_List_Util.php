...
if (!class_exists('WP_List_Util')) {
	...
	class WP_List_Util
	{
		 ...
		 * @since 4.7.0
		 *
		 * @param integer|string $field     Field from the object to place instead of the entire object
		 * @param integer|string $index_key Optional. Field from the object to use as keys for the new array.
		 *                                  Default null.
		 ...
		 *                                    is a string.
		 * @param boolean      $preserve_keys Optional. Whether to preserve keys. Default false.
		 ...
		 * @return integer 0 if both objects equal. -1 if second object should come first, 1 otherwise.
		 */
