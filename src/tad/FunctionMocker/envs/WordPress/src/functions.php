...
if (!function_exists('has_filter')) {
	 ...
	 * @return false|integer If $function_to_check is omitted, returns boolean for whether the hook has
...
if (!function_exists('_wp_filter_build_unique_id')) {
	 ...
	 * @param integer|boolean $priority Used in counting how many hooks were applied. If === false
