...
if (!class_exists('WP_Hook')) {
	...
	class WP_Hook implements Iterator, ArrayAccess
	{
		 ...
		 * @since 4.7.0
		 *
		 * @param boolean|integer $new_priority     Optional. The priority of the new filter being added. Default false,
		 *                                          for no priority being added.
		 * @param boolean         $priority_existed Optional. Flag for whether the priority already existed before the new
		 *                                          filter was added. Default false.
		 */
		protected function resort_active_iterations($new_priority = false, $priority_existed = false) {
		 ...
		 * @param integer  $priority           The exact priority used when adding the original filter callback.
		 * @return boolean Whether the callback existed before it was removed.
		 */
		 ...
		 * @param callable|boolean $function_to_check Optional. The callback to check for. Default false.
		 * @return boolean|integer The priority of that hook is returned, or false if the function is not attached.
		 */
		 ...
		 * @since 4.7.0
		 *
		 * @return boolean True if callbacks have been registered for the current hook, otherwise false.
		 */
		 ...
		 * @since 4.7.0
		 *
		 * @param integer|boolean $priority Optional. The priority number to remove. Default false.
		 */
		 ...
		 * @since 4.7.0
		 *
		 * @return integer|false If the hook is running, return the current priority level. If it isn't running, return false.
		 */
