...
class FunctionMocker
{
     ...
     * ```
     *
     * @param  mixed   ...$arguments  Arguments that are expected to be used to call the function. The arguments can be
     *                                scalar or instances of the `Prophecy\Argument` class.
     *
